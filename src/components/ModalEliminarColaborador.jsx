...
export default function ModalEliminarColaborador() {
	const { colaborador, handleModalEliminarColaborador, modalEliminarColaborador, eliminarColaborador } = useProyectos();
								...
								<div className='mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full'>
									...
									<div className='mt-2'>
										<p className='text-md text-gray-500'>
											Una vez eliminado el colaborador , no podra acceder al proyecto ...
										</p>
									</div>
								</div>
							</div>
